 ...
 */
@Configuration
@MapperScan("com.vitzro.mybatis.mapper")
...
public class DatabaseConfig {
	...
	public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception{
		...
		fb.setTypeAliasesPackage("com.vitzro.vo");
		fb.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:appQuery/*.xml"));
		return (SqlSessionFactory)fb.getObject();
	}
	
	@Bean
	public SqlSessionTemplate sqlSessionTemplate(SqlSessionFactory fb){
		return new SqlSessionTemplate(fb, ExecutorType.REUSE); 
	}
